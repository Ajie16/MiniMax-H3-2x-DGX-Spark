...
EXPECTED_HEAD_HOSTNAME="${EXPECTED_HEAD_HOSTNAME:-spark-db08}"
EXPECTED_WORKER_HOSTNAME="${EXPECTED_WORKER_HOSTNAME:-gx10-3028}"
...
h3_require_safe_value NCCL_IB_GID_INDEX "$GID"
...
check_node "$HEAD_HOST" "$EXPECTED_HEAD_HOSTNAME"
check_node "$WORKER_HOST" "$EXPECTED_WORKER_HOSTNAME"
